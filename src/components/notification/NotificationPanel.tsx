...
const NotificationPanel: React.FC = () => {
  ...
  // Animation variants for desktop dropdown
      ...
      {showNotificationPanel && (
        <>
          ...
          <motion.div
            ...
            className="hidden md:block absolute right-0 mt-2 w-80 lg:w-96 xl:w-[420px] rounded-xl shadow-2xl border border-gray-200 dark:border-gray-700 bg-white/95 dark:bg-gray-900/95 backdrop-blur-lg z-50"
          ...
          <motion.div
            ...
            exit="exit"
            transition={{ type: 'spring', stiffness: 300, damping: 30 }}
            className="md:hidden fixed left-1/2 top-1/2 z-[100] w-full max-w-sm -translate-x-1/2 -translate-y-1/2 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 bg-white/95 dark:bg-gray-900/95 backdrop-blur-lg"
            style={{ maxHeight: '80vh' }}
          >
            {/* Header */}
            <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700 bg-white/60 dark:bg-gray-900/60 rounded-t-2xl">
              <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200">Notifications</h3>
              <div className="flex items-center space-x-2">
                {unreadCount > 0 && (
                  <Button
            ...
            {/* Mobile close button */}
            <div className="p-4 border-t border-gray-200 dark:border-gray-700 bg-white/60 dark:bg-gray-900/60 rounded-b-2xl">
              <Button
                variant="secondary"
