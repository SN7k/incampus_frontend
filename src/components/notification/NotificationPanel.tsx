      ...
      {showNotificationPanel && (
        <>
          ...
          <motion.div
            ...
            className="fixed left-1/2 top-1/3 z-[100] w-full max-w-md sm:max-w-lg md:max-w-xl -translate-x-1/2 -translate-y-1/4 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 bg-white/80 dark:bg-gray-900/80 backdrop-blur-lg"
