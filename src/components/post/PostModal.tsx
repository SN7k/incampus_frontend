...
import { X, Image, Film, MapPin, Smile, Users, Plus } from 'lucide-react';
              ...
              <div className="mt-4 border border-gray-200 dark:border-gray-700 rounded-lg p-3">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex space-x-2">
                    ...
                    <button className="text-yellow-500 hover:bg-gray-100 dark:hover:bg-gray-700 p-2 rounded-full">
                      <Smile size={20} />
                    </button>
                    <button className="text-red-500 hover:bg-gray-100 dark:hover:bg-gray-700 p-2 rounded-full">
                      <MapPin size={20} />
                    </button>
                    <button className="text-purple-500 hover:bg-gray-100 dark:hover:bg-gray-700 p-2 rounded-full">
                      <Film size={20} />
                    </button>
